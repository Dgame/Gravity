...
//     sdl::Font::Mode mode = sdl::Font::Mode::Solid; // TODO: sobald dies entfernt wird auch den Font include auslagern
//
...
//     Font& formatFor(sdl::Renderer*, const std::string&, Arguments...);
//
...
//
// template <typename ...Arguments>
// void Font::formatFor(sdl::Renderer* renderer, const std::string& fmt, Arguments... args) {
