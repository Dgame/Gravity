...
INCLUDE_PATHS = -I $(DIR)\SDL2-2.0.3\include \
				-I $(DIR)\SDL2_image-2.0.0\include\SDL2 \
				-I $(DIR)\SDL2_ttf-2.0.12\x86_64-w64-mingw32\include\SDL2 \
				-I SDL\include
LIBRARY_PATHS = -L $(DIR)\SDL2-2.0.3\lib\x86 \
